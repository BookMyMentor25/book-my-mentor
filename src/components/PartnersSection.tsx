...
const PartnersSection = () => {
  ...
  return (
    <section id="partners" className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-secondary/50 via-background to-secondary/30 relative overflow-hidden">
      {/* Decorative background elements */}
      <div className="absolute inset-0 bg-[linear-gradient(45deg,transparent_25%,rgba(68,68,68,.05)_50%,transparent_75%,transparent_100%)] bg-[length:250px_250px]"></div>
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <div className="mb-8 sm:mb-12">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-muted-foreground mb-8 sm:mb-12 max-w-4xl mx-auto leading-relaxed">
        ...
        {/* Mobile: Scrollable grid showing ALL partners */}
        <div className="block sm:hidden mb-8">
          <div className="grid grid-cols-3 gap-3 max-h-[400px] overflow-y-auto px-2 py-2">
              ...
              <Card key={index} className="group hover:shadow-lg transition-all duration-300 border-0 bg-card/80 backdrop-blur-sm">
                <CardContent className="p-3 flex items-center justify-center min-h-[80px]">
                  <img 
                    src={partner.src} 
                    alt={partner.alt} 
                    className="h-10 w-auto max-w-full object-contain opacity-80 group-hover:opacity-100 transition-all duration-300"
                    loading="lazy"
                  />
                </CardContent>
              </Card>
          ...
          <p className="text-xs text-muted-foreground mt-2">Scroll to see all {partners.length} partners</p>
        </div>
            ...
            <CarouselContent className="-ml-2 md:-ml-4">
              {partners.map((partner, index) => (
                <CarouselItem key={index} className="pl-2 md:pl-4 basis-1/3 md:basis-1/4 lg:basis-1/6">
                  <Card className="group hover:shadow-xl transition-all duration-500 border-0 bg-gradient-to-br from-card via-card to-secondary/20 hover:from-card hover:to-primary/5 relative overflow-hidden">
                    {/* Shimmer effect */}
                    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-background/20 to-transparent -skew-x-12 translate-x-[-100%] group-hover:translate-x-[200%] transition-transform duration-1000"></div>
                    ...
                    {/* Glow effect */}
                    <div className="absolute inset-0 rounded-lg opacity-0 group-hover:opacity-20 transition-opacity duration-300 bg-gradient-to-br from-primary via-accent to-primary"></div>
                  </Card>
                </CarouselItem>
              ))}
            </CarouselContent>
            <CarouselPrevious className="hidden lg:flex -left-16 bg-card/90 backdrop-blur-sm border-primary/20 hover:bg-primary/10 hover:border-primary/30 text-primary" />
            <CarouselNext className="hidden lg:flex -right-16 bg-card/90 backdrop-blur-sm border-primary/20 hover:bg-primary/10 hover:border-primary/30 text-primary" />
          </Carousel>
        </div>

        <div className="text-center">
          <p className="text-base sm:text-lg text-muted-foreground mb-4">Want to become our partner?</p>
          <button 
            className="relative group text-primary hover:text-primary/80 font-semibold transition-all duration-300 text-sm sm:text-base px-6 py-2 rounded-full border border-primary/20 hover:border-primary/40 hover:bg-primary/5"
